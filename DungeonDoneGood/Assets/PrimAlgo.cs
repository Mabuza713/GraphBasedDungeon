...
namespace Graphdunegon
{
    public class PrimAlgo : MonoBehaviour
    {
        ...
        public List<Edge> currentEdgeList = new List<Edge>();
        ...
        public Edge CurrentPossibleEdges()
        {
            ...
            foreach (Node mainNode in  activatedNodesList)
            {
                foreach(Node tempNode in mainNode.linkedNodes)
                {
                    ...
                    {
                        // Setting up entrance and exit nodes might need to delete it after appending will see how path finding will work when two paths will lead to same Node
